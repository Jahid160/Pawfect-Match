...
const SECTION_ORDER = ["basic", "details", "pricing", "media"];
    ...
    return (
      <main className="min-h-screen bg-base-200 flex items-center justify-center p-6">
        <div className="bg-base-100 rounded-3xl shadow-2xl p-12 max-w-md w-full text-center">
          ...
          <h2
            className="font-black text-3xl text-neutral mb-2"
            style={{ fontFamily: "var(--font-playfair)" }}
          >
            Product Added!
          </h2>
          <p className="text-neutral/60 font-semibold mb-1">
            {form.productName}
          </p>
          <p className="text-neutral/40 text-sm mb-10">
            Successfully listed in your store.
          </p>
      ...
      <header className="bg-base-100 border-b border-base-300 sticky top-0 z-30">
        <div className="max-w-3xl mx-auto px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] text-neutral/40 uppercase tracking-widest font-bold">
                Admin Panel
              </p>
              <h1
                className="text-lg font-black text-neutral leading-none"
                style={{ fontFamily: "var(--font-playfair)" }}
              >
                Add Pet Food
              </h1>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-16">
        ...
        <div className="mb-5">
          <div className="flex justify-between text-xs mb-1">
            <span className="text-neutral/40 font-semibold">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          {activeSection === "basic" && (
            <Card>
              ...
              <Row>
                ...
                <Field label="Food Type" required error={errors.foodType}>
                  <select
                    ...
                    value={form.foodType}
                    onChange={handleChange}
                    className={inputCls(errors.foodType)}
                  >
              ...
              <Field
                label="Tags"
                hint="Comma-separated (e.g. grain-free, organic)"
              >
                <input
                  name="tags"
                  value={form.tags}
              ...
              <NavRow onNext={() => handleNext("details")} />
            </Card>
          )}
            ...
            <Card>
              ...
              <Row>
                ...
                >
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral/40 font-bold pointer-events-none">
                      ৳
                    </span>
                    <input
                      name="price"
              ...
              {form.price && (
                <div className="bg-base-200 rounded-2xl p-5 flex items-center justify-between">
                  <div>
                    <p className="text-[10px] text-neutral/40 uppercase tracking-widest font-bold mb-1">
                      Price Preview
                    </p>
                    <div className="flex items-center gap-3">
                      {form.discountPrice && (
                      ...
                      <span
                        className={`font-bold ${form.discountPrice ? "line-through text-neutral/30 text-lg" : "text-2xl text-primary"}`}
                      >
          ...
          {activeSection === "media" && (
            <Card>
              <SectionHeading
                icon="📸"
                title="Product Image"
                sub="Upload a clear product photo"
              />
              <div
              ...
              >
                ...
                {imagePreview ? (
                  ...
                  <>
                    <div
                      className="w-16 h-16 bg-base-200 rounded-2xl flex items-center justify-center
              ...
              {(form.productName || form.price) && (
                <div className="bg-base-200 rounded-2xl p-5 mt-4">
                  <p className="text-[10px] text-neutral/40 uppercase tracking-widest font-bold mb-3">
                    Order Summary
                  </p>
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-sm">
                    {[
                      ...
                      [
                        "Weight",
                        form.weight ? `${form.weight} ${form.weightUnit}` : "",
                      ],
                      ...
                      .map(([k, v]) => (
                        <div key={k}>
                          <span className="text-neutral/40 font-medium">
                            {k}:{" "}
                          </span>
                  ...
                  {form.ageGroup.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 mt-3">
                      {form.ageGroup.map((a) => (
                        <span
                          key={a}
                          className="bg-primary/10 text-primary/80 text-xs font-semibold px-3 py-0.5 rounded-full"
                        >
                          {a}
                        </span>
                      ))}
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn btn-primary rounded-xl flex-3 font-bold text-base shadow-lg shadow-primary/25 disabled:opacity-70"
                >
                  {loading ? (
                    <>
...
function Card({ children }) {
  return (
    <div className="bg-base-100 rounded-3xl shadow-sm p-6 sm:p-8 space-y-5 animate-[fadeUp_.25s_ease]">
      {children}
    </div>
  );
}
...
function SectionHeading({ icon, title, sub }) {
  return (
    <div className="flex items-center gap-3 pb-3 border-b border-base-200">
      ...
      <div>
        <h2
          className="font-black text-xl text-neutral leading-tight"
          style={{ fontFamily: "var(--font-playfair)" }}
        >
          {title}
        </h2>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-xs font-bold text-neutral/60 flex items-center gap-1">
        ...
        {hint && (
          <span className="text-neutral/30 font-normal ml-1">— {hint}</span>
        )}
      </label>
      {children}
      {error && (
