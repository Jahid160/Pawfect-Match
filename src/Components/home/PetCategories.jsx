    ...
    <section className="bg-[#FDFCFB] py-24">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="flex md:flex-row flex-col justify-between items-end gap-6 mb-16">
          ...
          {/* <Link
            href="/all-pets"
            className="group inline-flex items-center gap-2 pb-1 border-orange-500 border-b-2 font-black text-gray-900 hover:text-orange-500 text-sm uppercase tracking-widest transition-all duration-300"
          >
            View All Categories
