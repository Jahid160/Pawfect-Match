...
const heroSlides = [
  {
    id: 1,
    image: "https://i.ibb.co.com/HTgctbwy/web-P-1.webp",
  ...
  {
    id: 2,
    image: "https://i.ibb.co.com/0yN5QM4V/webp-2.webp",
    tag: "Feline companions",
    headline:
      'Bring Home a <span class="text-orange-500">Purr-fect</span> Soulmate.',
    description:
      "Elegant, independent, and full of love. Our rescue cats are waiting to fill your home with soft purrs and constant joy.",
  ...
  {
    id: 3,
    image: "https://i.ibb.co.com/PzWJvfp3/webp-3.webp",
    tag: "Colorful chirps",
    headline:
      'Fill Your Life with <span class="text-orange-500">Vibrant</span> Chirps.',
    description:
      "From talkative parrots to sweet canaries, find a feathered friend that brings melody and color to your world.",
  ...
  {
    id: 4,
    image: "https://i.ibb.co.com/rfHX6SMm/webp-4.webp",
    tag: "Small & Cuddly",
    headline:
      'Adorable <span class="text-orange-500">Bunnies</span> for Little Smiles.',
    description:
      "Gentle and curious, our rabbits are perfect for families looking for a soft, quiet, and playful companion.",
  ...
  {
    id: 5,
    image: "https://i.ibb.co.com/spJFnqTZ/webp5-1.webp",
    tag: "Serene Aquatics",
    headline:
      'Find Peace with <span class="text-orange-500">Aquatic</span> Beauty.',
    description:
      "Create a tranquil underwater world. Explore our collection of exotic fish and bring serenity to your living space.",
                ...
                <div className="group relative w-full max-w-[450px] lg:max-w-[550px] aspect-square">
                  ...
                  <div className="top-4 lg:top-10 -right-2 lg:-right-8 z-30 absolute flex items-center gap-2 lg:gap-3 bg-white/95 shadow-xl px-4 lg:px-6 py-3 lg:py-4 border border-slate-50 rounded-3xl lg:rounded-[2.2rem] animate-float">
                    ...
                    <div className="text-left">
                      <p className="font-black text-slate-900 text-xs lg:text-sm leading-none tracking-tight">
                        {slide.stats}
                      </p>
                      <p className="mt-1 font-bold text-[8px] text-slate-400 lg:text-[9px] uppercase tracking-[0.1em]">
                        Happy Homes
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bottom-6 lg:bottom-12 -left-2 lg:-left-10 z-30 absolute flex items-center gap-3 lg:gap-4 bg-white shadow-2xl p-4 lg:p-6 border border-slate-50 rounded-3xl lg:rounded-[2.5rem] animate-float-delayed">
                    ...
                    <div className="text-left">
                      <p className="font-black text-slate-900 text-sm lg:text-base leading-none tracking-tight">
                        Verified
                      </p>
                      <p className="mt-1 font-bold text-[9px] text-orange-500 lg:text-[10px] uppercase tracking-[0.2em]">
                        100% Healthy
                      </p>
                    </div>
                  </div>
