  ...
  return (
    <section className="relative bg-[#FDFDFD] py-20 overflow-hidden">
      <div className="top-0 left-0 absolute w-full h-full pointer-events-none">
        <div className="top-[-10%] left-[-5%] absolute bg-orange-500/5 blur-[120px] rounded-full w-[500px] h-[500px]" />
        <div className="right-[-5%] bottom-[-10%] absolute bg-orange-500/5 blur-[100px] rounded-full w-[400px] h-[400px]" />
      </div>
      ...
      <div className="z-10 relative mx-auto px-6 max-w-7xl">
        <div className="flex lg:flex-row flex-col justify-between items-end gap-12 mb-20">
          <div className="max-w-2xl lg:text-left text-center">
            ...
            >
              <Sparkles size={14} className="animate-pulse" /> The Impact We
              Make
            </motion.div>
          ...
          >
            We're on a mission to bridge the gap between abandoned pets and
            loving homes, one pawsitive step at a time.
          </motion.p>
        </div>
          ...
          {STATS_DATA.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white hover:bg-slate-900 p-10 border border-slate-100 hover:border-slate-900 rounded-[3rem] overflow-hidden transition-all duration-500 will-change-transform"
              >
                <div className="top-[-10%] right-[-10%] absolute bg-orange-400 opacity-0 group-hover:opacity-20 blur-2xl rounded-full w-24 h-24 transition-opacity duration-500" />
                ...
                <div className="z-10 relative">
                  <div className="flex justify-between items-start mb-12">
                    ...
                    <ArrowUpRight
                      className="opacity-0 group-hover:opacity-100 text-orange-500 transition-all -translate-x-4 translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 duration-500"
                      size={24}
                    />
                  </div>
