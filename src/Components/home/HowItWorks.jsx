  ...
  const steps = [
    {
      ...
      description:
        "Browse through our gallery of adorable pets and use filters to find the one that fits.",
    ...
    },
    {
      ...
      description:
        "Submit a simple adoption form with your details. Our team will review it safely.",
    ...
    },
    {
      ...
      description:
        "Schedule a meet-and-greet session to build a connection with your future companion.",
    ...
    },
    {
      ...
      description:
        "Complete the final paperwork and welcome your new family member forever!",
    ...
    <section className="relative bg-white py-20 overflow-hidden">
      <div className="z-10 relative mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div className="relative gap-12 lg:gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Icon Container */}
              <div
                className={`relative z-10 w-24 h-24 ${step.color} rounded-[2.5rem] flex items-center justify-center mb-8 shadow-sm group-hover:shadow-2xl group-hover:shadow-orange-100 group-hover:rotate-6 group-hover:-translate-y-2 transition-all duration-500 border-4 border-white`}
              >
        ...
        <div className="mt-24 text-center">
          <p className="mb-8 font-black text-[10px] text-slate-400 uppercase tracking-[0.3em]">
