      ...
      <div className="flex md:flex-row flex-col justify-between items-start md:items-center gap-6 mb-10">
        <div>
          ...
          <p className="mt-2 font-medium text-slate-500">
            Manage your community, assign roles, and monitor user activity.
          </p>
        </div>
                ...
                >
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="mb-1 font-bold text-slate-800 text-sm leading-none">
                          {user.name}
                        </p>
                  ...
                  <td className="px-6 py-5">
                    <span
                      className={`px-3 py-1.5 rounded-xl text-[10px] font-black uppercase flex items-center w-fit gap-1.5 ${
                        user.status === "active"
  ...
  `}
        ...
        <div className="flex justify-between items-center bg-slate-50/50 p-6 border-slate-100 border-t font-bold text-slate-400 text-xs">
          ...
          <div className="flex gap-2">
            <button className="bg-white hover:bg-white px-4 py-2 border border-slate-200 rounded-lg transition-all">
              Prev
            </button>
            <button className="bg-slate-900 hover:bg-orange-500 px-4 py-2 rounded-lg text-white transition-all">
              Next
            </button>
          </div>
        </div>
