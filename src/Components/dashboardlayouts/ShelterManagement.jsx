          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black uppercase ${shelter.status === 'Full' ? 'bg-rose-50 text-rose-600' : 'bg-emerald-50 text-emerald-600'
                  }`}>
              ...
              <div className="mb-8">
                ...
                <div className="bg-slate-50 p-0.5 border border-slate-100 rounded-full w-full h-3 overflow-hidden">
                  <motion.div
                    ...
                    className={`h-full rounded-full ${occupancyPercent > 90 ? 'bg-rose-500' : 'bg-orange-500'
                      }`}
                  />
                </div>
              </div>
