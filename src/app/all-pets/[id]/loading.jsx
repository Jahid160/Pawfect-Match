            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="rounded-2xl aspect-square bg-base-200 animate-pulse"
                  />
                ))}
              </div>
            </section>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="bg-white p-5 rounded-3xl h-24 border border-neutral/5 animate-pulse flex flex-col items-center justify-center gap-2"
                >
